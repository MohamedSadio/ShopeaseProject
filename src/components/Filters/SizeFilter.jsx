            ...
            {sizes?.map((item,index)=> {
              return (
                <div key={index} className='flex flex-col mr-2'>
                  <div className='w-52px border text-center mb-4 rounded-lg mr-4 cursor-pointer
                   hover:scale-110 transform bg-white border-gray-500 text-gray-500' style={appliedSize?.includes(item)?{
                    background:'black',
                    color:'white'
